...
int GenerateBBoxScene()
{
    ...
    ////    // Enlever un 0 à 7000, 4000 et 15000
    const Sphere leftWall = Sphere(Vector3(-widthOffset, 0., 0.), 3e4,  MaterialList::BleuMat, "Wall"); // Vert
    const Sphere rightWall = Sphere(Vector3(widthOffset, 0., 0.), 3e4, MaterialList::RougeMat, "Wall"); // Bleu
    const Sphere topWall = Sphere(Vector3(0., -heightOffset, 0.), 3e4, MaterialList::BlancMat, "Wall"); // Rose
    const Sphere bottomWall = Sphere(Vector3(0., heightOffset, 0.), 3e4, MaterialList::BlancMat, "Wall"); // Blanc
    ////    //    Sphere bottomWall = Sphere(Vector3(0., 4e5 + 4000., -00.), 4e5, Material(EMaterialType::DifuseType, Vector3(255 / 75, 255 / 140, 255 / 225)), "Rouge chelou");
    const Sphere backWall = Sphere(Vector3(0., 0., -3e4 - 1000), 3e4, MaterialList::BlancMat, "Wall"); // Bleu ciel
    const Sphere frontWall = Sphere(Vector3(0., 0., 3e4 + 1000), 3e4, MaterialList::BlancMat, "Wall"); // Jaune
    ...
    {
    myScene.AddSphere(Sphere(Vector3(-1500, -1000, 500), 50, MaterialList::BlancMat, "TopLeft"));
    ...
    
    {
        ...
        myScene.AddSphere(Sphere(Vector3(1350, 900, 600), 50, MaterialList::BlancMat, "BotRight"));
    }
    }
